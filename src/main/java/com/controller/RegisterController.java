...
public class RegisterController {
    ...
    public ModelAndView showRegistrationPage(ModelAndView modelAndView, User user) {
        ...
        //Builder feature will be added in future
        //modelAndView.addObject("builderList", userService.findBuildersList());
    ...
    public ModelAndView confirmRegistration(ModelAndView modelAndView, @RequestParam("token") String token) {
        ...
        Optional<User> optional = userService.findByConfirmationToken(token);
        ...
        modelAndView.setViewName("common/confirm");
        return modelAndView;
    }
    ...
    public ModelAndView confirmRegistration(ModelAndView modelAndView, BindingResult bindingResult, @RequestParam Map<String, String> requestParams, RedirectAttributes redir) {
        ...
        Optional<User> optional = userService.findByConfirmationToken(requestParams.get("token"));
        ...
        if (optional.isPresent()) {
            ...
            // Set user to role
            user.setUserRole(UserRoleEnum.ROLE_RESIDENTS.toString());
